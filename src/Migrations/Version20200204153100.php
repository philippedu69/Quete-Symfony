 ...
 */
final class Version20200204153100 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD author_id INT DEFAULT NULL, ADD episode_id INT DEFAULT NULL');
